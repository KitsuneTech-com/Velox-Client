...
## Requirements
VeloxJS expects to interact with a server-side implementation of the Velox MVA, or other scripts that serve requests and responses in a compatible manner. See the API section in https://github.com/KitsuneTech-com/Velox/blob/main/php/Readme.md for details on the expected protocol.
